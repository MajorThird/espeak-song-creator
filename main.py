...
def add_to_wave_of_track(
    ...
    - another silent wave if the wave generated by
      eSpeak is too short
    """
    wave_of_track = add_pause_before_note(
        wave_of_track, n, current_time, samples_per_sec)
    ...
    for n in track:
        ...
        while too_long:
            ...
            if get_audio_duration(speech_wav,
                ...
                too_long = False
        wave_of_track = add_to_wave_of_track(
            wave_of_track, speech_wav, n, current_time, samples_per_sec)
